...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future video() async {
    final result = await FilePicker.platform.pickFiles(
      ...
      allowedExtensions: ['mp4','MOV','WMV','AVI','AVCHD','FLV','F4V','SWF','MKV','WEBM ','HTML5','MPEG-2'],
    );
  ...
  Future documents() async {
    final result = await FilePicker.platform.pickFiles(
      allowMultiple: true,
      type: FileType.custom,
      allowedExtensions: ['pdf','word','DOC','DOCX','HTML','HTM','ODT','PDF','XLS','XLSX','ODS','PPT ','PPTX','TXT'],
    );
  ...
  Future audio() async {
    final result = await FilePicker.platform.pickFiles(
      allowMultiple: true,
      type: FileType.custom,
      allowedExtensions: ['mp3','audios','audio','3GA','AA','AA3','AAC','AAX','ABC','AC3','WAV','WMA','ZVR','M4A','FLAC','WAV','WMA'],
    );
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          onTap: (){
                                                                            ...
                                                                            // getimage();
                                                                            //  print('pressss');
                                                                               Navigator.push(context, MaterialPageRoute(builder: (context) => finguresketch()));
                                                                          },
